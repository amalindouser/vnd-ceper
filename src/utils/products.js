const products = [
    {
      ...
      src: '/public/Image/produk_image/Gambar_Produk_1.png',
    },
    {
      name: 'POLO',
      price: 'Harga mulai dari Rp85.000,-',
      specs: 'Cotton CVC Menggunakan mesin bordir komputer Kualitas standar clothing',
      src: '/public/Image/produk_image/Gambar_Produk_2.png',
    },
    {
      name: 'HOODIE & CREWNECK',
      price: 'Harga mulai dari Rp165.000,-',
      specs: ' Cotton Fleece sablon Plastisol Finishing Heatpress Doff',
      src: '/public/Image/produk_image/Gambar_Produk_3.png',
    },
    {
      name: 'KEMEJA',
      price: 'Harga mulai dari Rp102.000,-',
      specs: ' American Drill, Naga Drill, Hisofy Drill Menggunakan mesin bordir komputer',
      src: '/public/Image/produk_image/Gambar_Produk_4.png',
    },
    {
      name: 'JAS',
      price: 'Harga mulai dari Rp155.000,-',
      specs: 'American Drill, Nagata Drill, Valecta Texmoda Menggunakan mesin bordir komputer',
      src: '/public/Image/produk_image/Gambar_Produk_5.png',
    },
  ];
